...
//   //YE HMNE CART M NUMBER DILAKNE KE LIYE KIYA H
//   //PEHLE LOCAL STORAGE SE DISPATCH KARA ACTION
//   //THEN STORE M JAAKE CARTITME LE LIYE
//   //PHIT CHECK KARA AGAR CARTIEMS H TO SHOWN KARDO
//   //dispatch
//   useEffect(() => {
...
//   //local storage se user ka data liya then mobile view m agar login h to
//   // toggle se create and login hatta diya same aisa hi desktop view m kiya
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    {user?.userFound?.isAdmin && (
                      <Link
                        to="/admin"
                        className="inline-flex items-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-sm font-medium mr-2 text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                      >
                        Admin Dashboard
                      </Link>
                    )}
